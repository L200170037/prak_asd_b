...
c0 = MhsTIF('Al', 20, 'Bojonegoro', 5000000)
c1 = MhsTIF('Tamora', 5, 'Sragen', 2000000)
c2 = MhsTIF('Adit', 20, 'Surakarta', 4500000)
c3 = MhsTIF('Andra', 88, 'Sukoharjo', 935000)
c4 = MhsTIF('Ika', 41, 'Boyolali', 2900000)
c5 = MhsTIF('Rendi', 12, 'Solo', 3500000)
c6 = MhsTIF('Eni', 10, 'Klaten', 5450000)
c7 = MhsTIF('Salsa', 67, 'Malang', 8450000)
c8 = MhsTIF('bowo', 26, 'Klaten', 2350000)
c9 = MhsTIF('Alip', 45, 'Karanganyar', 4700000)
c10 = MhsTIF('Moses', 22, 'Solo', 7650000)
